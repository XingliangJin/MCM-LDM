...
humanact12_kinematic_chain_xyz = [[0, 1, 4, 7, 10],
                              [0, 2, 5, 8, 11],
                              [0, 3, 6, 9, 12, 15],
                              [9, 13, 16, 18, 20],
                              [9, 14, 17, 19, 21]]  # same as smpl

smpl_kinematic_chain = humanact12_kinematic_chain

smpl_kinematic_chain_xyz = humanact12_kinematic_chain_xyz
...
def plot_3d_motion(motion, length, save_path, params, title="", interval=50, palette=None):
    ...
    # fig = plt.figure(figsize=[2.6, 3.5])
    ...
    if motion.shape[0] == 18:
        ...
        kinematic_tree = smpl_kinematic_chain_xyz
    else:
        kinematic_tree = None
